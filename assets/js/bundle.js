...
module.exports = function () {
  ...
  return {
    ...
    begin: function begin() {
      ...
      floor = gfx.addFloor(scene, this.settings.colors.worldColor, this.settings.colors.gridColor); //gfx.enableStats(stats);
      ...
      var animate = function animate() {
        ...
        gfx.setCameraDirection(camera, new THREE.Vector3(self.settings.defaultCameraLocation.x + 1000 * count, self.settings.defaultCameraLocation.y, self.settings.defaultCameraLocation.z)); //geometry.verticesNeedUpdate = true;
...
(function () {
  ...
  window.gfx = function () {
    return {
      ...
      setCameraDirection: function setCameraDirection(camera, pt) {
        camera.lookAt(pt);
      },
